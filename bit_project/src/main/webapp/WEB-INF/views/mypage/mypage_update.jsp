...
<body>
	...
	<script src="${pageContext.request.contextPath}/resources/js/member_update.js"></script>
	<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
<script>
$('#postal_num').click(function() {
    goPopup();
 })
 $('#postal_num').keyup(function() {
    goPopup();
 })
 	function goPopup(){
	new daum.Postcode({
        oncomplete: function(data) {
            ...
            document.getElementById('postal_num').value = data.zonecode;
